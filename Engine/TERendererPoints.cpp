...
TERendererPoints::TERendererPoints() {}

TERendererPoints::TERendererPoints(String vertexSource, String fragmentSource) :
TERendererProgram(vertexSource, fragmentSource) {}

void TERendererPoints::run(TERenderTarget* target, TERenderPrimative* primatives, uint primativeCount) {
